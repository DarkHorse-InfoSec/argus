...
{
    lv_obj_set_style_text_font(dd, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(list, &font_dh_label_16, LV_PART_MAIN);
}
...
void nfc_write_screen_create()
{
    ...
    lv_obj_set_style_text_font(write_btn_label, &font_dh_label_20, LV_PART_MAIN);
    ...
    argus_keyboard_fit(keyboard, 220);
    lv_obj_add_flag(keyboard, LV_OBJ_FLAG_HIDDEN);
