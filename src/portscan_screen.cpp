...
static void result_row_add(int idx)
{
    ...
    lv_obj_set_style_text_font(h, &font_dh_label_20, LV_PART_MAIN);
...
void portscan_screen_create()
{
    ...
    lv_obj_set_style_text_font(lo_lbl, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(range_lo_ta, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(hi_lbl, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(range_hi_ta, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(start_btn_label, &font_dh_label_20, LV_PART_MAIN);
    lv_label_set_text(start_btn_label, "START");
