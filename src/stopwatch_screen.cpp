...
static void on_lap(lv_event_t *)
{
    ...
    lv_obj_set_style_text_font(entry, &font_dh_label_16, LV_PART_MAIN);
...
void stopwatch_screen_create()
{
    ...
    lv_obj_set_style_text_font(time_label, &font_dh_mono_48, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(lap_label, &font_dh_label_20, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(placeholder, &font_dh_label_16, LV_PART_MAIN);
