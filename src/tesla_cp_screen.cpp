...
void tesla_cp_screen_create()
{
    ...
    lv_obj_set_style_text_font(us_lbl, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(eu_lbl, &font_dh_label_16, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(send_btn_label, &font_dh_label_20, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(hint_label, &font_dh_label_14, LV_PART_MAIN);
