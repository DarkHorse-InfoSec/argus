                                  ...
                                  uint32_t seconds)
{
    ...
    lv_obj_set_style_text_color(lbl, lv_color_white(), LV_PART_MAIN);
    lv_obj_set_style_text_font(lbl, &font_dh_label_28, LV_PART_MAIN);
    lv_obj_center(lbl);
...
static void build_idle_panel()
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        lv_obj_set_style_text_font(u, &font_dh_label_28, LV_PART_MAIN);
...
static void build_run_panel()
{
    ...
    lv_obj_set_style_text_font(countdown_label, &font_dh_mono_48, LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(total_hint_label, &font_dh_label_16, LV_PART_MAIN);
